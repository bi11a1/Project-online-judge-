...
<html>
<head>
  <title>Beginner Problem Set</title>
        ...
        <tr class="user">
            ...
            <div style="background-color: #fff0f0">
                <h1 style="font-family: Monotype Corsiva;color:darkblue;text-align: center;">
                    <b>Beginner Problems for </b><b><?php echo $_SESSION['user_name']?></b>
                </h1>
                <br>
    
                <table class="set" style="width: 75%" align="center">
                    <tr class="set" style="background-color: #eb9494">
                ...
                $sql="SELECT problem_id,problem_name FROM problems WHERE problem_category='Beginner'";
