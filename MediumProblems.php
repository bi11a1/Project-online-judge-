...
<html>
<head>
  <title>Medium Problem Set</title>
    ...
    <table class="user" style="width: 100%">
        <tr class="user">
            ...
            <div style="background-color: #fff0f0">
                ...
                <b>Medium Hard Problems for </b><b><?php echo $_SESSION['user_name']?></b>
                </h1>
                <br>
            ...
            $sql="SELECT problem_id,problem_name FROM problems WHERE problem_category='Medium'";
